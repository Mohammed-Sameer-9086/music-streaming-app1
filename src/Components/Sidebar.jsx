...
import { FaHome, FaHeart, FaSearch, FaMusic, FaLine, FaPlayCircle, FaList, FaSignOutAlt, FaSignInAlt, FaSign, FaAlignLeft } from 'react-icons/fa';
import './sidebar.css'
    ...
    <nav className="sidebar">
      <ul className="list-unstyled">
       ...
       <li>
        ...
        <hr/>
       <div>
       <p style={{display:"flex",justifyContent:'center',fontSize:"30px"}}> Your Library</p>
        <li>
          <Link to="/favorities">
